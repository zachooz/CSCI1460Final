...
# Architecture
This model first builds sentence embeddings by passing word embeddings to a GRU and then passes these embeddings to a sentence level GRU to make predictions.
